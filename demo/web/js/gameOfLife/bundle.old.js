...
module.exports = function ExportBinary(map) {
  // Count of bits
  var bits = map.length;
...
self.GameOfLife = class GameOfLife {
  ...
  live(count, progressHandler, type = "json") {
    ...
    */
    ...
    life.cycles[0] = type === "binary" ? GameOfLife.binaryLife(startMap) : startMap;
...
},{"./Rules":1,"./binary-life":2}],4:[function(require,module,exports){
'use strict'
